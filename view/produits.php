...
$total=$conn->query("select count(*) from produit ;")->fetchColumn();
$pages = $total ;
        ...
        <div class="col-md-3 py-3 py-md-2">
          ...
          <div class="card">
            ...
            <a  style="text-decoration:none;"> 
             <a href="/description?id=<?=$produit['idProduit'] ?>" style="text-decoration: none;"> <h3 class="text-center"><?php echo $produit["nom"]; ?></h3></a> 
      ...
      Supprimer</button></a>
       <a href="/update?b=modifier&id=';
         ...
         Modifier
              ...
              <h2><?php echo $produit["prix_final"]; ?> <span><a class="fa-solid fa-cart-shopping"
