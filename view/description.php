   ...
   <div class="container" id="about">
        ...
        <div class="row" style="margin-top: 50px;">
            <div class="col-md-5 py-3 py-md-0">
                <div class="card">
                <img src="<?= $produit->select('*', $_GET['id'])["image"] ?>" alt="">  
                </div>
            </div>
            <div class="col-md-7 py-3 py-md-0">
          
            <h3 style="color:blue"class="text-center"><?= $produit->select('*', $_GET['id'])["nom"] ?></h3>
            <p class="text-center"><h3 style="color:blue">Réference:</h3><?= $produit->select('*', $_GET['id'])["REFERENCE"] ?></p>
            <p class="text-center"><h3 style="color:blue">Prix:</h3><?= $produit->select('*', $_GET['id'])["prix_final"] ?>DH</p>
